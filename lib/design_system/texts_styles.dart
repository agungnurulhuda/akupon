...
///////////////////////////////
  StylesText.heading1Regular(this.text,
      {super.key, this.color = const Color(0xFF171717)})
...
////// B O D Y - M E D I U M
///////////////////////////////
  StylesText.body1Medium(this.text,
      {super.key, this.color = const Color(0xFF171717)})
      : style = bodyMedium1.copyWith(color: color);

  StylesText.body2Medium(this.text,
      {super.key, this.color = const Color(0xFF171717)})
      : style = bodyMedium2.copyWith(color: color);

  StylesText.body3Medium(this.text,
      {super.key, this.color = const Color(0xFF171717)})
...
////// B O D Y - S E M I B O L D
///////////////////////////////
  StylesText.body1Bold(this.text,
      {super.key, this.color = const Color(0xFF171717)})
      : style = bodyBold1.copyWith(color: color);

  StylesText.body2Bold(this.text,
      {super.key, this.color = const Color(0xFF171717)})
      : style = bodyBold2.copyWith(color: color);

  StylesText.body3Bold(this.text,
      {super.key, this.color = const Color(0xFF171717)})
